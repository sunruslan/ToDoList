...
class MainForm(QWidget):
    ...
    def initUI(self):
        ...
        #                                              "border-color: red; }")
        # item = [QListWidgetItem('qwerty' + str(i)) for i in range(10)]
        # for i in item:
        #     self.list1.addItem(i)
        self.add_btn1 = QPushButton('Добавить')
        item = QListWidgetItem()
        self.list1.addItem(item)
        self.list1.setItemWidget(item, self.add_btn1)
        ...
        self.add_btn2 = QPushButton('Добавить')
        item = QListWidgetItem()
        self.list2.addItem(item)
        self.list2.setItemWidget(item, self.add_btn2)
        ...
        self.add_btn3 = QPushButton('Добавить')
        item = QListWidgetItem()
        self.list3.addItem(item)
        self.list3.setItemWidget(item, self.add_btn3)
        ...
        self.add_btn4 = QPushButton('Добавить')
        item = QListWidgetItem()
        self.list4.addItem(item)
        self.list4.setItemWidget(item, self.add_btn4)
